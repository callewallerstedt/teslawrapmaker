...
interface WrapHeaderWithLikesProps {
  title: string
  username?: string
  description?: string
  likes: number
...
export default function WrapHeaderWithLikes({ title, username, description, likes, createdAt, onLikesUpdate }: WrapHeaderWithLikesProps) {
  // Sync with parent component if provided
  const displayLikes = onLikesUpdate ? likes : likes
