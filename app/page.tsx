    ...
    <div className="min-h-screen bg-[#1a1a1a] relative flex flex-col">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-3 sm:px-5 lg:px-6 flex-1 flex items-center justify-center py-8">
        <div className="text-center">
          <h1 className="text-6xl font-semibold mb-6 tracking-tight text-[#ededed]/90" style={{ fontFamily: 'Anton, sans-serif', letterSpacing: '0.05em' }}>
            EvWrapStudio
          </h1>
          <p className="text-xl text-[#a0a0a0] max-w-2xl mx-auto mb-12 font-light leading-relaxed">
